...
@Component({
  selector: "app-sharepermitdesigndialog",
  templateUrl: "./sharepermitdesigndialog.component.html",
  styleUrls: ["./sharepermitdesigndialog.component.scss"],
})
export class SharepermitdesigndialogComponent implements OnInit {
  example: any = [];
  teamMember: User[] = [];
  TeamData: any = [];
  headers: HttpHeaders;
  ...
  SendMail() {
    ...
    return this.http
      .post(BaseUrl + "designs/send-permit-design", body, {
