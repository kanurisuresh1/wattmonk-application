...
export class MediaMessageComposerComponent {
  ...
  listItems = [
    {
      title: "Video",
      icon: "../../assets/icon_set/videocam-24px.svg",
      id: "video",
    },
    {
      title: "Audio",
      icon: "../../assets/icon_set/audiotrack-24px.svg",
      id: "audio",
    },
    {
      title: "File",
      icon: "../../assets/icon_set/insert_drive_file-24px.svg",
      id: "file",
    },
    {
      title: "Image",
      icon: "../../assets/icon_set/image-24px.svg",
      id: "image",
    },
